package dev.gaphunter.environmentspecificconstantcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.environmentspecificconstantcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.environmentspecificconstantcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Environment-Specific Constant Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34017-environment-specific-constant-companion/reviews"
